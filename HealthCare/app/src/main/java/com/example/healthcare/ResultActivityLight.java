...
public class ResultActivityLight extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_result_light);
        ...
        play.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(language.equals("ar")){
                    ttp.speak("من المحتمل أن يكون لديك:" + illness + "يمكنك الذهاب إلى الصيدلية للحصول على الدواء والقيام بما يلي" + treatment, TextToSpeech.QUEUE_FLUSH, null);
                    ...
                    ttp.speak("You probably have:"+illness+"You may go to the pharmacie for madication and do the following" +treatment, TextToSpeech.QUEUE_FLUSH, null);
        ...
        map.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(ResultActivityLight.this, mapspharmacie.class);
                startActivity(i);

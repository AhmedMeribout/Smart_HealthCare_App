...
public class DoctorActivity extends AppCompatActivity implements SelectDoctorListener {
    ...
    private void getData(String id) {
        ...
        RequestQueue queue = Volley.newRequestQueue(DoctorActivity.this);
        ...
        StringRequest jsonArrayRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    Toast.makeText(DoctorActivity.this, response, Toast.LENGTH_SHORT).show();
                }
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(DoctorActivity.this, "Fail to get the data..", Toast.LENGTH_SHORT).show();
            }
        }){
            @Override
    ...
    private void buildRecyclerView() {
        ...
        adapter = new AdapterDoctor(courseModalArrayList, DoctorActivity.this,this);
    ...
    public void onDoctorClicked(DoctorModel mymodel) {
        ...
        Toast.makeText(getApplicationContext(), mymodel.getSpeech(), Toast.LENGTH_SHORT).show();
